...
def test_state_contract_fields_exist() -> None:
    ...
    assert hasattr(state, "missing_keywords_before")
    assert hasattr(state, "missing_keywords_after")
    assert hasattr(state, "score_analysis")
    assert hasattr(state, "score_analysis_before")
    assert hasattr(state, "score_analysis_after")
    ...
    # New agent fields
    assert hasattr(state, "positioning_strategy")
    assert hasattr(state, "jd_analysis")
    assert hasattr(state, "gap_analysis")
    assert hasattr(state, "ats_qa_report")
